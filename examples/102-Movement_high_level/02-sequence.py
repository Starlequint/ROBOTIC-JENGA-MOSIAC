...
def create_cartesian_action(base_cyclic):
    ...
    action.application_data = ""
    #print("pos", cartesian_pose.x, cartesian_pose.y, cartesian_pose.z)
#    print("pos", feedback.base.tool_pose_x, feedback.base.tool_pose_y, feedback.base.tool_pose_z)
    ...
    cartesian_pose.y = feedback.base.tool_pose_y - 0.31    # (meters)
